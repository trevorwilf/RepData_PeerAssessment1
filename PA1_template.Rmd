...
```
The raw data mean was `r I(round(meansteps1, digits = 2))`.<br>
The raw data median was `r I(round(mediansteps1, digits = 2))`.<br>
...
```
The peak interval is signified by the red dot on the graph.  The peak occurs at the `r I(maxrow$interval)` interval and is `r I(round(maxrow$avgstepsperinterval, digits = 2))` steps.
...
```
The raw data mean was `r I(round(meansteps1, digits = 2))`.<br>
The imputed data mean was `r I(round(meansteps2, digits = 2))`.<br>
The difference in means is `r I(round(meansteps2 -meansteps1, digits = 2))`.

The raw data median was `r I(round(mediansteps1, digits = 2))`<br>
The imputed median mean was `r I(round(mediansteps2, digits = 2))`<br> 
The difference in median is `r I(round(mediansteps2 - mediansteps1, digits = 2))`<br>
...
The weekend mean for the intervals is `r I(round(wendmeansteps1, digits = 2))`<br>
The weekday mean for the intervals is `r I(round(wdaymeansteps1, digits = 2))`<br>
The difference is `r I(round(wendmeansteps1 - wdaymeansteps1, digits = 2))`<br>

The weekend median for the intervals is `r I(round(wendmediansteps1, digits = 2))`<br>
The weekday median for the intervals is `r I(round(wdaymediansteps1, digits = 2))`<br>
The difference is `r I(round(wendmediansteps1 - wdaymediansteps1, digits = 2))`<br>
